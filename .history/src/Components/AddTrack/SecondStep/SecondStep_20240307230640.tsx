      ...
      <form className={styles.form}>
        <div className={styles.inputs}>
          <div className={styles.input_wrapper}>
            ...
            <input
              type="file"
              className={styles.input + ' custom-file-input'}
              onChange={handleTrackChange}
            />
            <label className={styles.label1 + ' custom-file-label'}>
              {trackFileName || '.FLAC / .MP3 / .AAC'}
            </label>
          </div>
          {trackSelected && <IoIosCheckmarkCircleOutline color="white" fontSize={40} />}
          <div className={styles.input_wrapper}>
            ...
            <input
              ...
              placeholder={coverFileName || '.PNG / .JPG / .WEBP'}
              type="file"
              className={styles.input}
            />
          </div>
          {coverSelected && <IoIosCheckmarkCircleOutline color="white" fontSize={40} />}
        </div>
