...
import cookies from '../../assets/img/cookie.svg';
      ...
      <footer className={styles.footer}>
        <div className={styles.container}>
          ...
          <div className={styles.networks_wrapper}>
            <img className={styles.network} src={Google} alt="" />
            <img className={styles.network} src={Twitter} alt="" />
            <img className={styles.network} src={VK} alt="" />
            <img className={styles.network} src={Facebook} alt="" />
            <img className={styles.network} src={Instagram} alt="" />
          </div>
          <div className={styles.cookies_wrapper}>
            <img className={styles.image} src={cookies} alt="" />
            <span className={styles.text}>Файлы cookie</span>
          </div>
          <div className={styles.language_wrapper}>
            <img className={styles.image} src={language} alt="" />
